...
async def main(username, pwd, url):# 定义main协程函数，
    ...
    browser = await launch({'headless': False, 'args': ['--no-sandbox'], executablePath: '/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome'}) # 启动pyppeteer 属于内存中实现交互的模拟器
...
if __name__ == '__main__':
    ...
    url = 'https://passport.douyu.com/member/login?state=https%3A%2F%2Fwww.douyu.com%2Fmember%2Fcp'
